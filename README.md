...
Maven artifacts are built via Travis: [![Build Status](https://travis-ci.org/pac4j/undertow-pac4j.png?branch=1.1.x)](https://travis-ci.org/pac4j/undertow-pac4j) and available in the [Sonatype snapshots repository](https://oss.sonatype.org/content/repositories/snapshots/org/pac4j). This repository must be added in the Maven *pom.xml* file for example:
